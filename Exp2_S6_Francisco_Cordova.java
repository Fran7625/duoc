 ...
 */
package exp2_francisco_cordova_s6;
 ...
 * @author fcord
 */
public class Exp2_Francisco_Cordova_S6 {
    ...
    public static void main(String[] args) {
        ...
        double monto_total_predescuento = 0;
        ...
        for(int i=1; i<100; i++)
            if (seguir_programa) {
                System.out.println("Que desea hacer?: 1) Reservar entrada  2) Ver promociones  3)Eliminar ultima entrada  4)Mostrar ultima entrada  5)Comprar y salir");
                int res_usuario = scanner.nextInt();
                if (res_usuario == 1){ 
                    cantidad_entradas_vendidas +=1;
                    System.out.println("Que ubicacion desea reservar?: 1)VIP, 2)Platea, 3)General");
                    ...
                    System.out.println("Que fila desea reservar?: 1)A, 2)B, 3)C");
                    int fila_solicitada = scanner.nextInt();
                    if (fila_solicitada == 1){
                        System.out.println("Que asiento desea reservar?");
                        System.out.println("Presione 1 para reservar A-1");
                        System.out.println("Presione 2 para reservar A-2");
                        System.out.println("Presione 3 para reservar A-3");
                        ...
                        System.out.println("Que asiento desea reservar?");
                        System.out.println("Presione 1 para reservar B-1");
                        System.out.println("Presione 2 para reservar B-2");
                        System.out.println("Presione 3 para reservar B-3");
                        int asiento_solicitado = scanner.nextInt();
                        switch (asiento_solicitado){
                            case 1:
                        ...
                        System.out.println("Que asiento desea reservar?");
                        System.out.println("Presione 1 para reservar C-1");
                        System.out.println("Presione 2 para reservar C-2");
                        System.out.println("Presione 3 para reservar C-3");
                        int asiento_solicitado = scanner.nextInt();
                        switch (asiento_solicitado){
                            case 1:
                    ...
                    if (cantidad_entradas_vendidas == 0){
                        ...
                        System.out.println("No ha reservado ninguna entrada");
        ...
        monto_total_predescuento = monto_total;
        ...
        System.out.println("Cantidad de entradas compradas:" + cantidad_entradas_vendidas);
        System.out.println("Su total a pagar era: " + monto_total_predescuento);
        System.out.println("Su total a pagar con descuento es: " + monto_total);
